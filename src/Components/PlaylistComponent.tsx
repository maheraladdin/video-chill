...
export const PlaylistPage: React.FC<PlaylistPageProps> = ({
  ...
  return (
    <>
      <Head>
        <title>{playlist?.title ? playlist?.title + " - VidChill" : "playlist - VidChill"}</title>
        <meta name="description" content={playlist?.description || "VidChill awesome playlist"} />
...
export function SinglePlaylist({
  ...
  return (
    <div className="relative w-full">
      <div className="relative w-full">
        <Thumbnail thumbnailUrl={playlist?.playlistThumbnail} alt={`${playlist.title}'s playlist`} />
