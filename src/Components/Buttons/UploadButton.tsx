...
export function UploadButton({ refetch }: { refetch: () => Promise<unknown> }) {
  ...
  const handleSubmit = () => {
    ...
    fetch(
      `https://api.cloudinary.com/v1_1/${env.NEXT_PUBLIC_CLOUDINARY_NAME}/video/upload`,
  ...
  return (
    <>
      <Button
        ...
        variant="primary"
        size="2xl"
        className="ml-2 mt-4 md:mt-0 flex"
      >
        <Plus className="mr-1 h-5 w-5 shrink-0 stroke-white" />
        Upload
      </Button>
